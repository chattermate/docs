---
title: 'MCP Server'
description: 'Let AI agents manage ChatterMate through the Model Context Protocol by connecting the MCP server to Claude, IDE assistants, or any MCP-compatible client.'
---
