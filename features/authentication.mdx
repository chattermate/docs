...
description: 'Secure your ChatterMate chat widget with token-based authentication, choosing public access for anonymous visitors or authenticated mode to verify your users.'
---
