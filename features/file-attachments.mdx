...
description: 'Let customers share images, documents, and files in ChatterMate chats by enabling secure uploads per agent with configurable file types, sizes, and storage.'
---
