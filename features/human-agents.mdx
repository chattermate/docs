---
title: 'Human Agents'
description: 'Manage human agents in ChatterMate by adding users, assigning roles, organizing teams into groups, and routing chats so people and AI handle support together.'
---
