...
description: 'Set up your organization in ChatterMate by configuring your organization name, primary domain, and core workspace settings to get AI support ready in minutes.'
---
