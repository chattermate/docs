...
description: 'Customize ChatterMate AI agents with custom instructions, personality, and AI or workflow modes for consistent, on-brand support in your company voice.'
---
...
<Tabs>
  ...
  <Tab title="MCP Tools">
    <Frame>
      <img src="/images/mcp-tools.png" alt="MCP Tools" />
    </Frame>
