---
title: 'Quickstart'
description: 'Get started with ChatterMate in minutes by choosing the hosted service to launch from the dashboard or CLI, or self-hosting the full stack with Docker.'
---
